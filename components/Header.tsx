  ...
  return (
    <header className="w-full md:h-screen h-full">
      <div className="h-full flex flex-wrap justify-between sm:gap-8 gap-0">
        <div className="md:pl-6 sm:px-8 px-6 md:max-w-[55%] w-auto place-self-center md:pt-0 pt-20 md:pb-0 pb-20">
        ...
        <div className="md:max-w-[40%] w-full md:place-self-center place-self-end">
          <Image
            src="/header-bg.jpg"
